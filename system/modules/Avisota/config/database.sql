...
CREATE TABLE `tl_avisota_newsletter_outbox` (
  ...
  `pid` int(10) unsigned NOT NULL default '0',
  `tstamp` int(10) unsigned NOT NULL default '0',
  `plannedTime` int(10) unsigned NOT NULL default '0',
  PRIMARY KEY  (`id`),
  KEY `pid` (`pid`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8;
...
-- 
-- Table `tl_avisota_statistic_raw_recipient`
-- 
...
-- 
-- Table `tl_avisota_statistic_raw_link`
-- 
...
-- 
-- Table `tl_avisota_statistic_raw_recipient_link`
-- 
...
-- 
-- Table `tl_avisota_statistic_raw_link_hit`
-- 

CREATE TABLE `tl_avisota_statistic_raw_link_hit` (
  `id` int(10) unsigned NOT NULL auto_increment,
  `pid` int(10) unsigned NOT NULL default '0',
  `linkID` int(10) unsigned NOT NULL default '0',
  `recipientLinkID` int(10) unsigned NOT NULL default '0',
  `recipient` varchar(255) NOT NULL default '',
  `tstamp` int(10) unsigned NOT NULL default '0'
  PRIMARY KEY  (`id`),
  KEY `pid` (`pid`),
  KEY `linkID` (`linkID`),
  KEY `recipientLinkID` (`recipientLinkID`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8;
